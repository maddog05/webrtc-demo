...
import com.maddog05.webrtc.pares.CustomCameraEventsHandler;
import com.maddog05.webrtc.pares.CustomPeerConnectionObserver;
import com.maddog05.webrtc.pares.CustomSdpObserver;
...
public class ParesActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = "#Pares";
    ...
    public void start() {
        ...
        PeerConnectionFactory.initializeAndroidGlobals(ParesActivity.this, true);
        ...
        VideoCapturer videoCapturerAndroid = VideoCapturerMaker.make(ParesActivity.this, new CustomCameraEventsHandler());
    ...
    private void call() {
        ...
        remotePeer = peerConnectionFactory.createPeerConnection(iceServers, sdpConstraints, new CustomPeerConnectionObserver("remotePeerCreation") {
            ...
            public void onAddStream(MediaStream mediaStream) {
                ...
                //receive the stream from other user
    ...
    public void onIceCandidateReceived(PeerConnection peer, IceCandidate iceCandidate) {
        ...
        Log.i(TAG, iceCandidate.toString());
        if (peer == localPeer) {
